# OrthogonalArrayTest.py使用正交实验法设计测试用例，生成测试集。
# 代码源于GitHub作者lovesoo的OrthogonalArrayTest项目
# encoding: utf-8
# 正交实验法设计测试用例，基本步骤如下：
...
class OAT(object):
    def __init__(self, OAFile=os.path.split(os.path.realpath(__file__))[0] + '/OED/ts723_Designs.txt'):
        """
